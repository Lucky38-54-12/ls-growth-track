...
import { SalesCall, ScriptVersion, ScriptProposal, Lead, EmailEvent, EngagementSummary, PatternTracker, OnboardingNote } from "@/lib/types";
...
export default async function SalesCallsPage() {
  ...
  const [calls, { data: versions }, { data: pendingProposals }, allLeads, { data: events }, { data: scriptPatterns }, { data: onboardingNotes }] = await Promise.all([

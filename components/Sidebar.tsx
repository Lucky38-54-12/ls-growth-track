...
import {
  LayoutDashboard, Users, MailOpen, Phone, Calendar, Sun, Inbox, ScanSearch, Megaphone, Mailbox, Settings, Bot, BarChart3, Zap, Rows3, PhoneCall, Rocket, Flame,
} from "lucide-react";
...
export default function Sidebar() {
  ...
  if (path?.startsWith("/results") || path?.startsWith("/login") || path?.startsWith("/connect")) return null;
  return (
    <div style={{
